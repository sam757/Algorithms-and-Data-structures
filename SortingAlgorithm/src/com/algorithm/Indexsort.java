...
public class Indexsort {
	...
	public static long countsort(int[] a) {
		...
		int[] b = Countingsort.countSort(a);
	...
	public static void main(String[] args) {
		...
		for (int count = 0; count < numberOfSamples; count++) {
			...
			Indexsort.generateSample(originalSample, range);
			...
			long runTimeQuick = Indexsort.quicksort(a);
			...
			long runTimeCount= Indexsort.countsort(a);
			...
			long runTimeIndex = Indexsort.indexsort(a);
			...
			long runTimeBin = Indexsort.binsort(a);
